...
//        assertThat(preparedStmtList).containsExactly("testAuthToken");
    ...
    void testGetAuthSekQueryWithoutAuthToken() {
        ...
        // Then
        assertThat(query).isEqualTo(
                "SELECT auth_token, decrypted_sek, bill_id, business_service, service_number, total_due, mobile_number, paid_by, session_time, department_id  FROM auth_sek_session_data ORDER BY session_time "
        );
