...
public class AuthSekQueryBuilder {
    ...
    private final String BASE_QUERY = "SELECT auth_token, tenant_id, decrypted_sek, bill_id, business_service, service_number, total_due, mobile_number, paid_by, session_time ";
