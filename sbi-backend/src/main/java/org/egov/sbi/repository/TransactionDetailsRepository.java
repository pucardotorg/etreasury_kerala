...
public class TransactionDetailsRepository {
    ...
    public List<TransactionDetails> getTransactionDetails(String merchantOrderNumber) {
        List<String> preparedStmtList = new ArrayList<>();
        String query = queryBuilder.getTransactionDetailsQuery(merchantOrderNumber, preparedStmtList);
